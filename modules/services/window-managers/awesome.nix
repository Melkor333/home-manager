...
# {{{ The effective configuration
  ...
  configFile = pkgs.writeText "rc.lua" ((if cfg.config != null then with cfg.config; ''
...
${variablesStr variables.extraVariables}
${unquotedVariablesStr variables.unquotedExtraVariables}

${optionalString (variables.terminal != null) "terminal = \"${toString variables.terminal}\""}
${optionalString (variables.editor != null) "editor = \"${toString variables.editor}\""}
${optionalString (variables.editor_cmd != null) "editor_cmd = ${toString variables.editor_cmd}"}
...
-- The following code is oudated (no shared tags)
-- for i = 1, 9 do
--     globalkeys = gears.table.join(globalkeys,
--         -- View tag only.
--         awful.key({ modkey }, "#" .. i + 9,
